...
def _fallback_lesson_from_meaning(proverb: str, meaning: str) -> str:
    ...
    if any(word in normalized for word in ["မှား", "အမှား", "မိုက်", "ထပ်မံ", "ဆင်ခြင်"]):
        return _pick_variant(
            proverb,
            [
                "တစ်ခါမှားခဲ့တာကို အရှုံးလို့မယူဘဲ နောက်တစ်ကြိမ်မှာ ပိုသတိထားနိုင်ဖို့ သင်ခန်းစာအဖြစ်ယူရမယ်ဆိုတာ သင်ပေးပါတယ်။",
                "မစဉ်းစားဘဲလုပ်မိတဲ့အမှားကို ထပ်မလုပ်အောင် ကိုယ့်အတွေ့အကြုံကနေ ဆင်ခြင်တတ်ဖို့ သင်ပေးပါတယ်။",
                "အမှားတစ်ခုကြောင့် စိတ်ဓာတ်ကျနေမယ့်အစား ဘာကြောင့်မှားသလဲဆိုတာ ပြန်သုံးသပ်ပြီး နောက်တစ်ခါ ပိုမှန်ကန်အောင်လုပ်ဖို့ သင်ပေးပါတယ်။",
            ],
        )
    ...
    if any(word in normalized for word in ["ကဲ့ရဲ့", "ချီးမွမ်း", "အပြစ်တင်"]):
        return _pick_variant(
            proverb,
            [
                "လူများ၏ ကဲ့ရဲ့ခြင်း၊ ချီးမွမ်းခြင်းကို အလွန်မတုန်လှုပ်ဘဲ ကိုယ်မှန်ကန်တာကို တည်တည်ငြိမ်ငြိမ်လုပ်ဆောင်ဖို့ သင်ပေးပါတယ်။",
                "ပြင်ပစကားသံတွေက အချိန်နဲ့အမျှပြောင်းနိုင်တာကြောင့် ကိုယ့်အပြုအမူကို ပိုအရေးထားပြီး စိတ်ကိုတည်ငြိမ်စေဖို့ သင်ပေးပါတယ်။",
            ],
        )

    if any(word in normalized for word in ["နေကောင်း", "ရေချိုး", "ရက်", "ကျန်းမာ"]):
        return "ကျန်းမာရေးနဲ့ပတ်သက်တဲ့အခါ အလျင်မလိုဘဲ ကိုယ့်အခြေအနေကို သေချာကြည့်ပြီးမှ ဆုံးဖြတ်လုပ်ဆောင်ဖို့ သင်ပေးပါတယ်။"
    if any(word in normalized for word in ["ဆရာ", "တပည့်", "ပညာ", "သင်"]):
        return "သင်ယူထားတဲ့ပညာကို လက်တွေ့အသုံးချပြီး စဉ်ဆက်မပြတ်ကြိုးစားမှ တိုးတက်မှုရနိုင်ကြောင်း သင်ပေးပါတယ်။"
    if any(word in normalized for word in ["မိဘ", "သားသမီး", "ကလေး"]):
        return "မိသားစုအတွင်း တာဝန်ယူမှု၊ နားလည်မှုနဲ့ ပြုပြင်ဆုံးမမှုကို ပေါ့ပေါ့မထားသင့်ကြောင်း သင်ပေးပါတယ်။"
    if any(word in normalized for word in ["ကြိုးစား", "အားထုတ်", "လုံ့လ"]):
        return "အောင်မြင်မှုလိုချင်ရင် အခက်အခဲကြုံလည်း ဇွဲမလျှော့ဘဲ ဆက်လက်အားထုတ်ဖို့ သင်ပေးပါတယ်။"
    if any(word in normalized for word in ["သတိ", "ဆင်ခြင်", "စဉ်းစား"]):
        return "အလုပ်မလုပ်ခင် အကျိုးအပြစ်ကို ချင့်ချိန်ပြီး သတိရှိရှိဆုံးဖြတ်ရင် အမှားနည်းနိုင်ကြောင်း သင်ပေးပါတယ်။"
    return _pick_variant(
        proverb,
        [
            f"ဒီစကားပုံရဲ့ အဓိပ္ပါယ်ကို ကိုယ့်နေ့စဉ်ဆုံးဖြတ်ချက်တွေမှာ ပြန်စဉ်းစားပြီး သင့်တော်သလို အသုံးချဖို့ သင်ပေးပါတယ်။",
            f"အခြေအနေတစ်ခုကို တစ်ဖက်တည်းမကြည့်ဘဲ အဓိပ္ပါယ်ရင်းကိုနားလည်ပြီး မှန်ကန်စွာ ပြုမူဆောင်ရွက်ဖို့ သင်ပေးပါတယ်။",
            f"ကိုယ်ကြုံရတဲ့အရာတွေကို သေချာသုံးသပ်ပြီး နောင်အတွက် ပိုကောင်းတဲ့အပြုအမူ ရွေးချယ်နိုင်ဖို့ သင်ပေးပါတယ်။",
        ],
    )
...
def _fallback_example_from_meaning(proverb: str, meaning: str) -> str:
    ...
    if any(word in normalized for word in ["မှား", "အမှား", "မိုက်", "ထပ်မံ", "ဆင်ခြင်"]):
        return _pick_variant(
            proverb,
            [
                "ကျောင်းသားတစ်ယောက်က စာမေးပွဲမပြင်ဆင်လို့ မအောင်ခဲ့ပြီး နောက်တစ်ကြိမ်မှာ အချိန်ဇယားဆွဲကာ ကြိုတင်လေ့လာတာမျိုး ဖြစ်ပါတယ်။",
                "အလုပ်မှာ အချက်အလက်မစစ်ဘဲပို့မိလို့ ပြဿနာတက်ပြီး နောက်ပိုင်းမှာ ပို့ခါနီးတိုင်း နှစ်ခါပြန်စစ်တာမျိုး ဖြစ်ပါတယ်။",
                "သူငယ်ချင်းကို စကားကြမ်းပြောမိလို့ စိတ်ဆိုးသွားပြီး နောက်တစ်ခါ ပြောမယ့်စကားကို အရင်စဉ်းစားတာမျိုး ဖြစ်ပါတယ်။",
            ],
        )
    if any(word in normalized for word in ["ကဲ့ရဲ့", "ချီးမွမ်း", "အပြစ်တင်"]):
        return "လူတစ်ယောက်ကို ယနေ့ဝေဖန်နေကြပေမယ့် သူ့အလုပ်ကောင်းကောင်းပြီးသွားတဲ့အခါ ပြန်ချီးမွမ်းကြတာမျိုး ဖြစ်ပါတယ်။"
    if any(word in normalized for word in ["နေကောင်း", "ရေချိုး", "ရက်", "ကျန်းမာ"]):
    ...
    return _pick_variant(
        proverb,
        [
            "မိသားစု၊ ကျောင်း၊ အလုပ်ခွင်ထဲမှာ အခြေအနေတစ်ခုကြုံတဲ့အခါ ဒီစကားပုံရဲ့ သဘောတရားနဲ့ ကိုက်ညီသလို ပြန်ရှင်းပြနိုင်ပါတယ်။",
            "သူငယ်ချင်းတစ်ယောက်က အလားတူအခြေအနေကြုံလာရင် ဒီစကားပုံကို ဥပမာထားပြီး သင့်တော်တဲ့အပြုအမူကို အကြံပေးနိုင်ပါတယ်။",
            "နေ့စဉ်ဘဝမှာ ဆုံးဖြတ်ချက်ချရမယ့်အချိန်မျိုးမှာ ဒီစကားပုံရဲ့ အဓိပ္ပါယ်ကို ပြန်သတိရပြီး အသုံးချနိုင်ပါတယ်။",
        ],
    )
...
async def arag_answer(
    ...
    if response_language == "my" and settings.chat_provider.strip().lower() == "gemini":
        return await _aanswer_from_best_source(sources, response_language)
